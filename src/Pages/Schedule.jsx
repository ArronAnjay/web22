...
const Schedule = () => {
    ...
    piketGroup = [
        ["Resa", "Naufal", "Adit", "Alfino", "Andin","Aceng","Christian"],
        ["Divana", "Faida", "Abid", "Fatihah", "Haddad","Helga","isnaeni"],
        ["kaila", "Misdalifah", "Adib", "Rafiq", "Alifian","Irsyad","Izzuddin"],
        ["Rizqi", "Syakur", "Jaya", "Nabigh", "Naila","Nova","Oliver"],
        ["Pranawira", "Sabila", "Sofyan", "Syahkila","Deo","Yolanda"],
    ]
