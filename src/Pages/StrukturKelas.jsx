	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="M.wahyu Nugroho,S.Kom" Width="200px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Achmad Naufal Rezky P." Width="200px" />
					</div>
					...
					<img src="LineHorizontalPendek.svg" className="relative top-3 hidden lg:flex" />
					<img src="LineHorizontalPendek.svg" className="relative top-3 hidden lg:flex" />
					<div className="relative right-[3.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Annisa Fadhilla" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Divana arelyam" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Aanisah Karimatul B." Width="150px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Helga Cleo h." Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Faida Shaima" Width="120px" />
					</div>
				</div>

				<div className="relative top-[-16rem]" data-aos="fade-up" data-aos-duration="900">
...
<div className="lg:flex">
					...
					<img
						src="LineHorizontal.svg"
						alt=""
						className="relative top-[-16.5rem] hidden lg:flex lg:w-[4.2rem]"
						data-aos="fade-up"
						data-aos-duration="600"
					/>
				</div>
				...
				<div
					className="flex gap-[10.6rem] relative top-[-17.45rem] lg:gap-[27.4rem]"
					data-aos="fade-up"
					data-aos-duration="800">
					<img src="LineKananKiri.svg" alt="" />
					<img src="LineKananKiri.svg" alt="" />
				...
				<div
					className="flex gap-[10.6rem] relative top-[-18.2rem] lg:gap-[27.4rem]"
					data-aos="fade-up"
					data-aos-duration="1000">
					<img src="Circle.svg" alt="" />
					<img src="Circle.svg" alt="" />
				...
				<div
					className=" flex gap-[5rem] relative top-[-18.5rem] lg:gap-[21.5rem]"
					data-aos="fade-up"
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan" Nama="Wirasera Al Bozali" Width="150px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="M.Syakur" Width="120px" />
					</div>


					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="kebersihan" Nama="Sabila Arni" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Misdalifah" Width="120px" />
					</div>
				</div>
